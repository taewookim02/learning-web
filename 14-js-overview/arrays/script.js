...
// String works too!!!
console.log('hhuhuhu lolo'.at(-1));

/////////////////////////////////////////////////
// For Each (looping arrays)
...
const arr = [1, 2, 34, 5, 67, 8];
console.log(new Array(1, 2, 34, 5, 67, 8));
...
console.log(convertTitleCase('this is a LONG title but not doo long'));
